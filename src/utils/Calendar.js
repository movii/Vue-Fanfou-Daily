let t = new Date()
let todayString = `${t.getFullYear()}-${t.getMonth() + 1 < 10 ? '0' + (t.getMonth() + 1) : t.getMonth() + 1}-${ t.getDate() < 10 ? '0' + t.getDate() : t.getDate() }.daily.json`

export default class Calendar {
  constructor() {
    this.monthOlympic = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31]
    this.monthNormal = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31]
  }
  ...
  getCountOfDayInSpecificMonth(month, year) {
    return year % 4 === 0 
      ? this.monthOlympic[month] 
      : this.monthNormal[month]
  }
}